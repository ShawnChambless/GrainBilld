...
angular.module("personalProject").service("loginService",["$http","$q",function(t,e){var r=null;this.currentUser=function(){return r},this.getCurrentUser=function(){var n=e.defer();return t({method:"GET",url:"http://grainbilld.com/api/user/"}).success(function(t){r=t,n.resolve(t)}).error(function(t){n.reject(t)}),n.promise},this.register=function(r,n,o,a){var i=e.defer();return t({method:"POST",url:"http://grainbilld.com/auth/local/signup",data:{firstName:r,lastName:n,email:o,password:a}}).then(function(t){i.resolve(t.data)},function(t){i.reject(t)}),i.promise},this.login=function(n,o){var a=e.defer();return t({method:"POST",url:"http://grainbilld.com/auth/local/login",data:{email:n,password:o}}).then(function(t){r=t.data,a.resolve(t.data)},function(t){a.reject(t)}),a.promise}}]);
angular.module("personalProject").controller("recipeCtrl",["$scope","recipeService","retrieveRecipes",function(e,r,c){e.recipes=c}]);
angular.module("personalProject").service("recipeService",["$http",function(e){this.user={},this.getRecipes=function(t){return e({method:"GET",url:"http://grainbilld.com/api/recipes/"+t})}}]);
